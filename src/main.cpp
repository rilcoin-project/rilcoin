...
uint256 hashGenesisBlock("0xd646738ca7abe4ca7e12c044e432ab7e8125174b375b9896921f07928eba0e28");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Rilcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Rilcoin Signed Message:\n";
...
{
    // Rilcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 800000); // Clonecoin: 800k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Rilcoin: 5 minutes
static const int64 nTargetSpacing = 2.5 * 60; // Rilcoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Rilcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd646738ca7abe4ca7e12c044e432ab7e8125174b375b9896921f07928eba0e28");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1521644020;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1746871;
;
...
;
        ...
        assert(block.hashMerkleRoot == uint256("0x7966b381e79a2a909706356a33b5507b4de22f26d67cb188f0d1fb3327c0da33"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Rilcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RilcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RilcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static RilcoinMiner(CWallet *pwallet)
{
    printf("RilcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("rilcoin-miner");
    ...
    try { loop {
        ...
        printf("Running RilcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("RilcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&RilcoinMiner, pwallet));
}
