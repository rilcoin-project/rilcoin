...
<context>
    ...
    <message>
        ...
        <translation>Rilcoin Core клиент</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Rilcoin</translation>
    </message>
    <message>
        <source>Modify configuration options for Rilcoin</source>
        <translation>Изменить параметры конфигурации Rilcoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Rilcoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашим адресом Rilcoin, чтобы доказать, что вы им владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Rilcoin addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом Rilcoin</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Запросить платежи (создаёт QR-коды и rilcoin: ссылки)</translation>
    </message>
    <message>
        <source>&amp;About Rilcoin Core</source>
        <translation>&amp;О Rilcoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть rilcoin: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать помощь по Rilcoin Core и получить список доступных параметров командной строки.</translation>
    </message>
    <message numerus="yes">
        <source>%n active connection(s) to Rilcoin network</source>
        <translation><numerusform>%n активное соединение с сетью</numerusform><numerusform>%n активных соединений с сетью</numerusform><numerusform>%n активных соединений с сетью Rilcoin</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным Rilcoin-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Rilcoin Core.</translation>
    </message>
    <message>
        <source>As this is the first time the program is launched, you can choose where Rilcoin Core will store its data.</source>
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где Rilcoin Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>Rilcoin Core скачает и сохранит копию цепи блоков. Как минимум, %1ГБ данных будет храниться в этом каталоге, и со временем он будет расти. Бумажник будет также сохранён в этом каталоге.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически запускать Rilcoin после входа в систему</translation>
    </message>
    <message>
        <source>&amp;Start Rilcoin on system login</source>
        <translation>&amp;Запускать Rilcoin при входе в систему</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Rilcoin-клиента на роутере. Работает только если Ваш роутер поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Rilcoin через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети Rilcoin через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска Rilcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Rilcoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить rilcoin: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать URI! Это может быть связано с неверным адресом Rilcoin или неправильными параметрами URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Rilcoin (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл Rilcoin из текущего каталога данных. Это может занять несколько секунд для больших лог-файлов.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добро пожаловать в RPC-консоль Rilcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Rilcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Rilcoin</translation>
    </message>
    <message>
        <source>(no label)</source>
        <translation>[нет метки]</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Rilcoin, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>К rilcoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Rilcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Rilcoin Core выключается...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Rilcoin, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выберите ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение адресом Rilcoin</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Rilcoin, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Rilcoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Rilcoin</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось забиндиться на %s на этом компьютере. Возможно, Rilcoin Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, Rilcoin Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссии (в RIL/Кб) меньшие этого значения считаются нулевыми для трансляции (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Fees (in RIL/Kb) smaller than this are considered zero fee for transaction creation (default: %s)</source>
        <translation>Комиссии (в RIL/Кб) меньшие этого значения считаются нулевыми для создания транзакции (по умолчанию: %s)</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Rilcoin Alert" admin@foo.com
        ...
        <translation>Для использования rilcoind или опции rilcoin-qt -server, вы должны установить опцию rpcpassword в конфигурационном файле:
 %s
...
Например: alertnotify=echo %%s | mail -s "Rilcoin Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: убедитесь, что дата и время на Вашем компьютере выставлены верно. Если Ваши часы идут неправильно, Rilcoin Core будет работать некорректно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: бумажник требует более новую версию Rilcoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия (в RIL/Кб) для добавления к вашим транзакциям (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Information</source>
        <translation>Информация</translation>
    ...
    <message>
        ...
        <translation>Не удалось проверить чистоту. Rilcoin Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Параметры RPC SSL: (см. Rilcoin вики для инструкций по настройке SSL)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать бумажник, перезапустите Rilcoin Core для завершения операции.</translation>
    </message>
    <message>
        <source>Warning</source>
        <translation>Внимание</translation>
